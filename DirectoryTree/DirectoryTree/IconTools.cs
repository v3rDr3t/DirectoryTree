...
public static class IconTools {
    ...
    public static Icon GetFolderIcon(ShellIconSize size) {
        SHFILEINFO shinfo = new SHFILEINFO();
        NativeMethods.SHGetFileInfo(null, FILE_ATTRIBUTE_DIRECTORY, ref shinfo, (uint)Marshal.SizeOf(shinfo), size);
